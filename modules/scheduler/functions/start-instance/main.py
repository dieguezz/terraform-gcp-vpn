"""
Cloud Function to start a GCP Compute Engine instance.

This function is triggered by Cloud Scheduler to start the VPN instance
at the beginning of business hours for cost optimization.
...
def start_instance_handler(request):
    """
    HTTP Cloud Function entry point to start instance.
    ...
    return manage_instance("start", project_id, zone, instance_name)
